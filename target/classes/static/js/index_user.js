...
document.getElementById("SuperHeader").innerHTML =
    ...
    "<div class='col-md-1 id = text_M1'><a class = 'menu-item' style= 'text-decoration: none;' href='/cart'>Shopping cart </a></div>"+
    "<div class='col-md-1 id = text_M1'><a class = 'menu-item' style= 'text-decoration: none;' href='/orders'>Order history </a></div>"+
    "<div class='col-md-1 id = text_M2'" +
    "      <form method= 'post' action='/logout'>" +
    "        <a class = 'menu-item' style= 'text-decoration: none;' href='/product'>Exit</a>" +
    "      </form>" +
    "     </div>"+
    "</div></div>"+
    "<div class='kontainer'>"+
    ...
    "<p class='text-center'><br>Electrohouse. <br>"+
    ...
    "<input type='text' autocomplete='off' class='form-control' placeholder='Find' name='search' id='search'>"+
